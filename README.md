...
📍 **Purdue** | 🎓 **CS student — ML + Computer Graphics, Honors College** | 🤖 **Agent-native tooling**
...
- 🔁 **[review-loop](https://github.com/DavidChen-006/review-loop)** — a builder commits, a reviewer spawns in a disposable worktree, a FAIL files an issue
- 🧰 **[agent-skills](https://github.com/DavidChen-006/agent-skills)** — canonical skills and agent identity files, shared across every harness I run
- 🚦 **[ci-gate-lab](https://github.com/DavidChen-006/ci-gate-lab)** — experiments in what CI should block an agent on
- 🚧 **[human-gate-lab](https://github.com/DavidChen-006/human-gate-lab)** — experiments in where a human has to stay in the loop
...
- 🎒 **[Brightspace Bar](https://github.com/DavidChen-006/Brightspace-Bar)** — macOS menu bar app for Brightspace; agents can read courses and add assignments
- ⌨️ **[BrightspaceCLI](https://github.com/DavidChen-006/BrightspaceCLI)** — Brightspace (D2L) from the terminal: agent-native course data and heatmap entry
- ✂️ **[cleanmap](https://github.com/DavidChen-006/cleanmap)** — strips the clutter from an image and returns the main subject
